...
class GICA_Design_Settings {
    ...
    public function render_settings_page() {
        ...
        ?>
        <div class="gica-design-settings">
            <h1 class="gica-design-settings__title">Personalización de Programas Académicos</h1>
            ...
            <form method="post" action="options.php" class="main-title__form">
                ...
                <h2 class="main-title__subtitle">Título principal</h2>
